  ...
  - [3 数据仓库](/数据仓库/README.md)
    ...
    - [3.5 大数据](/数据仓库/大数据/README.md)
      - [3.5.1 不作恶](/数据仓库/大数据/不作恶.md)
      - [3.5.2 大数据平台](/数据仓库/大数据/大数据平台.md)
      - [3.5.3 大数据生态圈](/数据仓库/大数据/大数据生态圈.md)
      - [3.5.4 大数据的未来](/数据仓库/大数据/大数据的未来.md)
      - [3.5.5 数据的特性](/数据仓库/大数据/数据的特性.md)
    - [3.6 数据中台](/数据仓库/数据中台/README.md)
      - 3.6.1 中台建构
        - [3.6.1.1 数据栈](/数据仓库/数据中台/中台建构/数据栈.md)
        - [3.6.1.2 评价维度](/数据仓库/数据中台/中台建构/评价维度.md)
      - [3.6.2 元数据管理](/数据仓库/数据中台/元数据管理/README.md)
        - [3.6.2.1 Amundsen](/数据仓库/数据中台/元数据管理/Amundsen.md)
      - [3.6.3 数据中心](/数据仓库/数据中台/数据中心/README.md)
        - [3.6.3.1 云数据中心](/数据仓库/数据中台/数据中心/云数据中心.md)
      - 3.6.4 数据治理
        - [3.6.4.1 原则与要素](/数据仓库/数据中台/数据治理/原则与要素.md)
        - [3.6.4.2 数据零散化](/数据仓库/数据中台/数据治理/数据零散化.md)
    - [3.7 数据湖](/数据仓库/数据湖/README.md)
      
    - [3.8 数据网格](/数据仓库/数据网格/README.md)
      
    - [3.9 数据集成](/数据仓库/数据集成/README.md)
      - [3.9.1 Canal](/数据仓库/数据集成/Canal/README.md)
        - [3.9.1.1 架构机制](/数据仓库/数据集成/Canal/架构机制.md)
        - [3.9.1.2 部署与配置](/数据仓库/数据集成/Canal/部署与配置.md)
      - [3.9.2 DataPipeline](/数据仓库/数据集成/DataPipeline/README.md)
        - [3.9.2.1 一致性语义](/数据仓库/数据集成/DataPipeline/一致性语义.md)
        - [3.9.2.2 数据汇集层](/数据仓库/数据集成/DataPipeline/数据汇集层.md)
        - [3.9.2.3 数据源监听](/数据仓库/数据集成/DataPipeline/数据源监听.md)
        - [3.9.2.4 数据转换与检索](/数据仓库/数据集成/DataPipeline/数据转换与检索.md)
        - [3.9.2.5 运行环境与引擎](/数据仓库/数据集成/DataPipeline/运行环境与引擎.md)
      - [3.9.3 Debezium](/数据仓库/数据集成/Debezium.md)
      - [3.9.4 ETL](/数据仓库/数据集成/ETL/README.md)
  ...
  - [5 消息系统](/消息系统/README.md)
    ...
    - [5.5 架构设计](/消息系统/架构设计/README.md)
      - [5.5.1 事件流](/消息系统/架构设计/事件流.md)
      - [5.5.2 框架对比](/消息系统/架构设计/框架对比.md)
      - [5.5.3 消息存储](/消息系统/架构设计/消息存储.md)
      - [5.5.4 消息消费](/消息系统/架构设计/消息消费.md)
      - [5.5.5 消息类型](/消息系统/架构设计/消息类型.md)
      - [5.5.6 集群与高可用](/消息系统/架构设计/集群与高可用.md)
